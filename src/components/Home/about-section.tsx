...
const AboutSection = () => {
  return (
    <section
      id="about"
      className="relative w-full px-6 lg:px-12 2xl:px-0 max-w-[1440px] mx-auto py-16 lg:py-24"
    >
      <div className="w-full pt-8">
        <span className="text-sm uppercase font-medium text-muted-foreground pb-4 mb-16 block border-b border-white/10 ">
          About Us
        </span>
