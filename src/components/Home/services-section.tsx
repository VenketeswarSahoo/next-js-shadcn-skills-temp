...
const ServicesSection = () => {
  ...
  return (
    <section ref={targetRef} className="relative h-[240vh] bg-black">
        ...
        <motion.div style={{ x, willChange: "transform" }} className="flex">
          ...
          <div className="flex h-screen w-[75vw] flex-none flex-col justify-between px-6 py-24 lg:px-12 lg:py-32">
            ...
            <p className="max-w-md text-muted-foreground text-sm md:text-lg">
              Brand, product, AI, blockchain, and media. All under one roof, all
              moving at the speed your business demands. We ship what other
              agencies scope out for six months.
            </p>
          </div>
