...
function DrawerOverlay({
  ...
  return (
    <DrawerPrimitive.Overlay
      ...
      className={cn(
        "fixed inset-0 z-50 bg-black/30 supports-backdrop-filter:backdrop-blur-sm data-open:animate-in data-open:fade-in-0 data-open:duration-400 data-open:ease-[var(--ease-out-expo)] data-closed:animate-out data-closed:fade-out-0 data-closed:duration-200 data-closed:ease-in",
        className
      )}
      {...props}
    />
